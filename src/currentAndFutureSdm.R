...
#get our occurence data, just lat, long
...
#plot your occurrence points on top of that
...
# change x and y colmns to longitude and latitude
...
# create a variable of a presence/absence
presenceAbsenceV <- c(rep(1, nrow(occEnv)), rep(0, nrow(absenceEnv))) 

#create a single data frame of presence/absence data by climate variable (combine them)
...
# make our bounding box a little bigger
...
# make a raster layer for the map, confining everything
